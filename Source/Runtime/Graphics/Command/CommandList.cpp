...
void CommandList::BindIndexBuffer(const std::shared_ptr<GraphicsBuffer>& indexBuffer)
{
...
void::CommandList::BindResources(const std::vector<std::shared_ptr<TextureView>>& textureViews, const std::vector<std::shared_ptr<Sampler>>& samplers,
